      ...
      <div className="home-content">
        ...
        <div className="library-link">
          <div className="link w-radius">
            <span>{npmAddress}</span>
            <button className={`w-btn link-btn ${copiedStatus && 'active-btn'}`} onClick={() => handleCopyClick()}>
              {copiedStatus ? successIcon: textIcon }
            </button>
          </div>
          <div className="vist">
